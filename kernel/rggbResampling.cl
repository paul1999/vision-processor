...
kernel void rggbResampling(read_only image2d_t topleft, read_only image2d_t topright, read_only image2d_t bottomleft, read_only image2d_t bottomright, write_only image2d_t out, const CameraModel model, const float maxRobotHeight, const float fieldScale, const float fieldOffsetX, const float fieldOffsetY) {
